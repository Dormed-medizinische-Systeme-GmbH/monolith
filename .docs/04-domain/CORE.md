...
Herkunft in [`../00-legacy/Adressen/Adressen-Zuordnung.md`](../00-legacy/Adressen/Adressen-Zuordnung.md)).

Modul: `app/Modules/Crm/` (Namespace `App\Modules\Crm\`, ADR-033). Diese Spec legt **Felder,
...
**Erweiterung (D-133)** — aus der realen Auswahlliste des Website-Kontaktformulars,
die bisher eine **zweite, konkurrierende** Liste war: **Allgemeinmedizin / Hausarzt**
· **Innere Medizin** · **Gynäkologie** · **Urologie** · **Sonstiges**.

Es gibt damit **eine einzige** Fachgebietsliste: das Kontaktformular zieht seine
Auswahl **aus dieser Tabelle** statt aus einem hartcodierten Array
([`COMMUNICATION.md`](COMMUNICATION.md)). „Sonstiges" ist eine Agent-Ergänzung —
der D-019-Seed hatte keinen Auffangwert, das Formular braucht aber einen.

> **Offen (Kosmetik):** die Benennung ist dadurch gemischt — der Altsystem-Seed
> nennt Personen im Plural („Orthopäden", „Kardiologen"), die neuen Werte nennen
> Fachgebiete („Gynäkologie", „Innere Medizin"). Eine Vereinheitlichung wäre
> sinnvoll, berührt aber Bestandsdaten und ist eine eigene Entscheidung.
...
- **Soft-Delete + Papierkorb** (D-018, D-023): jedes Modell hier inkl. Pivots
  ...
  **Management / Geschäftsführung** (D-139, revidiert D-023 — Backoffice **nicht**
  mehr). Endgültige Löschung automatisch nach **30 Tagen** per `model:prune`;
  **niemand** kann endgültig löschen, `forceDelete` wird keiner Rolle erteilt. Details / Modell-Regel → `.ai/rules` + Infra-Doc

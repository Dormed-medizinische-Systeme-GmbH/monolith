...
Modul: `app/Modules/Sales/` (Namespace `App\Modules\Sales\`, `depends_on: [Core, Inventory]`, ADR-033 — Inventory neu durch D-099/D-117, Katalogbezug der Positionen).
...
| 6 | ~~Angebots-PDF-Erzeugung~~ | ✅ gelöst — Blade-Template im Belegarten-Katalog, [`DOCUMENTS.md`](DOCUMENTS.md) (D-141/D-144) |

...
Die XML-Definition (`.docs/00-legacy/Adressen/Adressen.xml`) enthält 356 Spalten, davon rund 176 Kunden-/Custom-Felder.
...
Die Struktur ist ein guter Hinweis auf ein zukünftiges `SalesOpportunity`, aber nicht zwingend dessen finales Schema. (`.docs/00-legacy/Verkaufschancen/Verkaufschancen.xml`, 34 Spalten)
...
Zukünftig sollte `Appointment` als Scheduling-Objekt von fachlichen Vorgängen sauber getrennt werden. (`.docs/00-legacy/Termine/Termine.xml`, 25 Spalten)
...
Das ist ein überladenes Universalobjekt und wird nicht als Zielstruktur übernommen. (`.docs/00-legacy/Tickets/Tickets.xml`, 112 Spalten)
...
Die XML-Definition (`.docs/00-legacy/Servicevertraege/Servicevertraege-NEU.xml`) umfasst 83 Spalten.

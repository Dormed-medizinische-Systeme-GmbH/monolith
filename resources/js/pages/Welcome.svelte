    ...
    >
        ...
        >
            ...
            >
                <!-- Laravel Logo -->
                <svg
                    class="w-full text-[#F53003] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 motion-safe:starting:translate-y-6"
                    viewBox="0 0 438 104"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <!-- 13 -->
                <svg
                    class="w-[438px] max-w-none relative -mt-[6.6rem] -ml-8 lg:ml-0 [--stroke-color:#1B1B18]"
                    viewBox="0 0 440 392"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                >

...
## Zwei Adressen für dasselbe MinIO

Die häufigste Stolperstelle:

- `AWS_ENDPOINT=http://minio:9000` — aus Sicht des **PHP-Containers** (Docker-Netz)
- `AWS_URL=http://localhost:9000/dormed-public` — aus Sicht des **Browsers**
